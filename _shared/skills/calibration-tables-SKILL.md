...
For repo-specific code-versus-paper checking, pair this skill with the [`code-paper-crosswalk`](../agents/code-paper-crosswalk.md) agent.
...
- [`calibration-tables-examples.md`](calibration-tables-examples.md)
