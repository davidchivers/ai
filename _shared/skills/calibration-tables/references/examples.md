...
- Table A.1 and surrounding parameterization discussion: [AEA materials appendix](https://www.aeaweb.org/articles/materials/8561)
...
- Table IV with `Parameter | Description | Canada | Chile | Notes`: [QJE article](https://academic.oup.com/qje/article/141/1/605/8261558)
...
- Table 1, `Calibrated Parameter Values and Calibration Targets`: [paper PDF](https://crei.cat/wp-content/uploads/2024/04/QMT-pub-1.pdf)
...
- Table I, `Description | Value | Target/Source`: [paper PDF](https://bpb-us-w2.wpmucdn.com/campuspress.yale.edu/dist/c/4765/files/2025/05/ug_pub.pdf)
