#!/usr/bin/env python3
"""Rank the 2026-05-11 perfect-foresight bridge/polish probes."""
...
def main():
    ...
    parser.add_argument("--grid", default="model_pf_bridge_0511.csv")
    parser.add_argument("--out-dir", default="truth/pf_bridge_0511")
    ...
    out_csv = out_dir / "pf_bridge_ranked_0511.csv"
    with out_csv.open("w", newline="") as fh:
        writer = csv.DictWriter(fh, fieldnames=fields, extrasaction="ignore")
        writer.writeheader()
        writer.writerows(ranked)

    out_md = out_dir / "pf_bridge_report_0511.md"
    with out_md.open("w", encoding="utf-8") as fh:
        fh.write("# Perfect-Foresight Bridge/Polish 2026-05-11\n\n")
        if ranked:
            best = ranked[0]
