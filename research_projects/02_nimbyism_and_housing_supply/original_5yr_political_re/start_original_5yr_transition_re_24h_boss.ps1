...
$bossProc = Start-Process powershell -ArgumentList @(
    ...
    "-File", (Join-Path $scriptDir "watch_original_5yr_transition_re_24h_boss_supervisor.ps1"),
    "-LiveRoot", $liveRoot,
    "-MatlabExe", $MatlabExe,
...
Write-Output ("Started 24-hour RE boss supervisor pid=" + $bossProc.Id + " keep-awake pid=" + $keepProc.Id)
