...
$proc = Start-Process powershell -ArgumentList @(
    ...
    "-File", (Join-Path $scriptDir "watch_original_5yr_transition_political_re_reporter.ps1")
...
Write-Output ("Started original 5-year transition political RE reporter pid=" + $proc.Id)
