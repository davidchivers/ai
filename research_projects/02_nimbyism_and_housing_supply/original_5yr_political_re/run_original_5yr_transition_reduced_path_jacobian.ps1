...
$matlabCommand = @"
addpath('$scriptDir');
[summary, results] = run_original_5yr_transition_reduced_path_jacobian($MaxK, $MaxOuterIter, $BasisCount, $seedPriceCsvExpr, $runTagExpr, '$DemographicSourceMode', $FiniteDiffStep, $RidgeLambda, $candidateScalesExpr, $TrustRegionLogStep, $ActiveThresholdFrac, $PriceFloor, $PriceCap);
disp(summary);
exit;
"@
