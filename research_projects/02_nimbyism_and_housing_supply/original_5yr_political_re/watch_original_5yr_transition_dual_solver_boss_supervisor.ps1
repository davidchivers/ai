...
Write-Log "Dual solver boss supervisor started."
...
do {
    ...
    $proc = Start-Process powershell -ArgumentList @(
        ...
        "-File", (Join-Path $scriptDir "run_original_5yr_transition_dual_solver_boss.ps1"),
        "-LiveRoot", $LiveRoot,
        "-MatlabExe", $MatlabExe,
    ...
    Write-Log "Launched dual boss pid=$($proc.Id)"
    $proc.WaitForExit()
