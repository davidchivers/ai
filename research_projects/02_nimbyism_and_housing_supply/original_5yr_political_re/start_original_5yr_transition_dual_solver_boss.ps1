...
$bossProc = Start-Process powershell -ArgumentList @(
    ...
    "-File", (Join-Path $scriptDir "watch_original_5yr_transition_dual_solver_boss_supervisor.ps1"),
    "-LiveRoot", $liveRoot,
    "-MatlabExe", $MatlabExe,
...
Write-Output ("Started dual solver boss supervisor pid=" + $bossProc.Id + " keep-awake pid=" + $keepProc.Id)
