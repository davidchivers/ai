...
$matlabCommand = @"
addpath('$scriptDir');
[summary, results] = run_original_5yr_joint_wedge_smoothed($MaxK, $MaxOuterIter, $BasisCount, $seedPriceCsvExpr, $runTagExpr, '$DemographicSourceMode', $FiniteDiffStep, $RidgeLambda, $candidateScalesExpr, $TrustRegionLogStep, $ActiveThresholdFrac, $WedgeFloor, $WedgeCap, $kScheduleExpr, $HousingClearMaxIter, $PoliticalResponseSigma);
disp(summary);
exit;
"@
