...
Dropbox now contains a revised paper draft at `C:\Users\Dave_\Dropbox\exposure_attitudes\Draft\exposure_segregation_social_capital.pdf`. The current revision uses a standard Durham Department of Economics author block, an integrated one-section literature review, paper-facing academic prose rather than code/export narration, the generated county summary table, standardized first-stage table, compact preferred county-outcomes table, Stantcheva adolescent-exposure table, first-stage figures, and appendix copies of the generated regression fragments.
