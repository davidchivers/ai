...
\begin{figure}[H]\caption{Transition responses to a low-education separation shock.}\label{fig:case147_mit_lowedu_sep010_irf}\centering\includegraphics[width=0.95\textwidth]{../figures/case147_mit_lowedu_sep010_irf.pdf}\par\medskip\footnotesize \emph{Note:} Panels report percentage-point deviations from the benchmark transition start state.\end{figure}
