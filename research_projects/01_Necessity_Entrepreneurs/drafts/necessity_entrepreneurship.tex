...
\par\end{centering}
\centering{}\includegraphics[width=0.82\textwidth]{../figures/enter_period_employed_submission} 
\end{figure}
...
\par\end{centering}
\centering{}\includegraphics[width=0.82\textwidth]{../figures/enter_period_unemployed_submission} 
\end{figure}
...
\begin{figure}[H]\caption{Transition responses to a low-education separation shock.}\label{fig:case147_mit_lowedu_sep010_irf}\centering\includegraphics[width=0.95\textwidth]{../figures/case147_mit_lowedu_sep010_irf.pdf}\par\medskip\footnotesize \emph{Note:} Panels report percentage-point deviations from the benchmark transition start state after a low-education separation shock. The top-left panel shows the overall entrepreneur share, the top-right the low-education entrepreneur share, the bottom-left the self-employment share, and the bottom-right the low-education unemployment share.\end{figure}
