...
| Paper | Key claim used in draft | Relevance to current paper | Confidence |
|---|---|---|---|
| Fairlie and Fossen (2019, NBER WP) | Prior labor-market status provides an operational necessity-vs-opportunity definition. | Directly matches model decomposition of entry by prior employment status. | High |
| Buera (2009) | Borrowing constraints affect entrepreneurial entry and firm scale; welfare effects can be sizable. | Direct support for frictions-driven selection and scale margins. | High |
| Hurst and Pugsley (2011) | Many small businesses are not innovation-led and nonpecuniary motives are important. | Supports broad occupational-choice view of entrepreneurship. | High |
| Petrongolo and Pissarides (2001 working paper version) | Aggregate matching functions discipline unemployment-vacancy-hiring flows. | Supports search-friction block used for occupational transitions. | Medium |
| Sedlacek and Sterk (2017, repository full text with DOI 10.1257/aer.20141280) | Startup composition and growth potential vary over the cycle. | Supports composition-based interpretation of entrepreneurship dynamics. | High |
...
- `lucas_1978` [UNVERIFIED - exact paper PDF not yet restored]
- `evans_jovanovic_1989` [UNVERIFIED - exact paper PDF not yet restored]
- `hurst_lusardi_2004` [UNVERIFIED - exact paper PDF not yet restored]
- `cagetti_denardi_2006` [UNVERIFIED - exact JPE PDF not restored; precursor WP version available]
- `mortensen_pissarides_1994` [UNVERIFIED - exact paper PDF not yet restored]
- `donovan_lu_schoellman_2023` [UNVERIFIED - exact QJE PDF not restored; FRB staff report precursor available]
