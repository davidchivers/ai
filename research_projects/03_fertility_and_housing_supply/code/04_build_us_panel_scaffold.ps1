...
$dictLines = @(
    ...
    "| first_births_total | float | count of first births in geography-year |",
    "| first_birth_rate_15_44 | float | first births per 1,000 women ages 15-44 |",
    "| mean_age_first_birth | float | mean maternal age among first births |",
    "| median_age_first_birth | float | median maternal age among first births (possibly grouped-age approximation) |",
    "| share_first_birth_15_19 | float | share of first births to mothers ages 15-19 |",
    "| share_first_birth_20_24 | float | share of first births to mothers ages 20-24 |",
    "| share_first_birth_25_29 | float | share of first births to mothers ages 25-29 |",
    "| share_first_birth_30_34 | float | share of first births to mothers ages 30-34 |",
    "| share_first_birth_35_44 | float | share of first births to mothers ages 35 and older in the top grouped bin |",
    "| share_first_birth_30_plus | float | share of first births to mothers ages 30 and older |",
