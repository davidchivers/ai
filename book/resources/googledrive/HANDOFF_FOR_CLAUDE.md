...
- `book/README.md` reframed for book workflow
- `book/memory.md` updated with collaboration context
- `_shared/memory/RESEARCH_STYLE.md` updated with global book preferences
- `book/googledrive/INDEX.md` contains current Google Docs index
- `book/googledrive/refresh_drive_index.ps1` refreshes `INDEX.md`
...
- Cannot create privileged filesystem link/junction into `book` from this session.
